...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/stats", permission: authz.ChannelRead, handler: controller.GetChannelStats},
	{method: http.MethodGet, path: "/bad_count", permission: authz.ChannelRead, handler: controller.GetBadChannelCount},
	{method: http.MethodPost, path: "/stats/refresh", permission: authz.ChannelOperate, handler: controller.RefreshChannelStats},
	...
	{method: http.MethodGet, path: "/update_upstream_used", permission: authz.ChannelOperate, handler: controller.UpdateAllChannelsUpstreamUsed},
	{method: http.MethodGet, path: "/update_upstream_used/:id", permission: authz.ChannelOperate, handler: controller.UpdateChannelUpstreamUsed},
	{method: http.MethodPost, path: "/priority_monitor", permission: authz.ChannelOperate, handler: controller.RunChannelPriorityMonitorAPI},
	...
	{method: http.MethodPatch, path: "/:id/models", permission: authz.ChannelWrite, handler: controller.PatchChannelModels},
	...
	{method: http.MethodPost, path: "/batch/enable", permission: authz.ChannelOperate, handler: controller.BatchEnableChannels},
	{method: http.MethodPost, path: "/batch/disable", permission: authz.ChannelOperate, handler: controller.BatchDisableChannels},
	{method: http.MethodPost, path: "/batch/edit", permission: authz.ChannelWrite, handler: controller.BatchEditChannels},
	...
	{method: http.MethodGet, path: "/auto_enable", permission: authz.ChannelRead, handler: controller.GetAllAutoEnableChannels},
	{method: http.MethodPost, path: "/auto_enable/batch/get", permission: authz.ChannelRead, handler: controller.BatchGetChannelAutoEnableStatus},
	{method: http.MethodPost, path: "/auto_enable/batch/set", permission: authz.ChannelWrite, handler: controller.BatchSetChannelAutoEnableStatus},
	{method: http.MethodGet, path: "/auto_enable/:id", permission: authz.ChannelRead, handler: controller.GetChannelAutoEnableStatus},
	{method: http.MethodPost, path: "/auto_enable/:id", permission: authz.ChannelWrite, handler: controller.SetChannelAutoEnableStatus},
	{method: http.MethodPost, path: "/settings/batch/get", permission: authz.ChannelRead, handler: controller.BatchGetChannelSettings},
	{method: http.MethodGet, path: "/settings/:id", permission: authz.ChannelRead, handler: controller.GetChannelSettings},
	{method: http.MethodPost, path: "/settings/:id", permission: authz.ChannelWrite, handler: controller.SetChannelSettings},
	{method: http.MethodGet, path: "/rpm/:id", permission: authz.ChannelRead, handler: controller.GetChannelMaxRPM},
	{method: http.MethodPost, path: "/rpm/:id", permission: authz.ChannelWrite, handler: controller.SetChannelMaxRPM},
